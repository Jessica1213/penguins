...
import { updateMemoryAction } from "@/app/actions";
...
export function EditMemoryClient({ memory, penguins }: EditMemoryClientProps) {
    ...
    const handleSubmit = async (data: Omit<Memory, "id">) => {
        ...
        try {
            await updateMemoryAction(memory.id, data);
