...
import { deletePenguinAction, deleteMemoryAction } from "@/app/actions";
import { cn } from "@/lib/utils";
import { MemoryModal } from "@/components/memories/MemoryModal";

interface AdminDashboardClientProps {
    initialPenguins: Penguin[];
    initialMemories: Memory[];
}

export function AdminDashboardClient({ initialPenguins, initialMemories }: AdminDashboardClientProps) {
    const [penguins, setPenguins] = useState<Penguin[]>(initialPenguins);
    ...
    const handleDeletePenguin = async (id: string) => {
        if (confirm("Are you sure you want to delete this penguin?")) {
            await deletePenguinAction(id);
