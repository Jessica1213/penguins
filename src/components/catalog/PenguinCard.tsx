...
export function PenguinCard({ penguin }: PenguinCardProps) {
    return (
        <Link href={`/penguins/${penguin.id}`}>
            <div className="group relative bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-slate-100 dark:border-slate-800">
